...
abstract class AppConfig with _$AppConfig {
  ...
  T read<T>(SettingsKey<T> key) =>
      (switch (key) {
            ...
            .viewerOriginalVideoOnWifi => viewer.originalVideoOnWifi,
            .viewerOriginalVideoOnCellular => viewer.originalVideoOnCellular,
            .viewerOriginalVideoRequireLan => viewer.originalVideoRequireLan,
  ...
  AppConfig write<T, U extends T>(SettingsKey<T> key, U value) {
    return switch (key) {
      ...
      .viewerOriginalVideoOnWifi => copyWith(viewer: viewer.copyWith(originalVideoOnWifi: value as bool)),
      .viewerOriginalVideoOnCellular => copyWith(viewer: viewer.copyWith(originalVideoOnCellular: value as bool)),
      .viewerOriginalVideoRequireLan => copyWith(viewer: viewer.copyWith(originalVideoRequireLan: value as bool)),
